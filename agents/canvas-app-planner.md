...
description: >-
  ...
  designs the aesthetic direction and screen plan; presents plan for user approval via a markdown approval prompt;
...
- The plugin root directory, which contains `agents/`, `skills/`, and `references/`
...
## Step 3 — Design and Present Plan for Approval
